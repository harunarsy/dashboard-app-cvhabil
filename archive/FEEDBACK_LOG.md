...
- **Protokol Seharusnya:** Berdasarkan protokol yang sudah disepakati, kredensial yang sah adalah `admin`/`<password-dihapus-dari-riwayat>` untuk admin, dan `direktur`/`<password-dihapus-dari-riwayat>` untuk role direktur.
