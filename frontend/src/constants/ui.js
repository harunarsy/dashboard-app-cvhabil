...
export const UI_COLOR = {
  ...
  actionPressed: 'var(--color-action-pressed)',
  selection: 'var(--color-selection)',
  selectionStrong: 'var(--color-selection-strong)',
  selectionSubtle: 'var(--color-selection-subtle)',
  actionBorder: 'var(--color-action-border)',
  actionBorderStrong: 'var(--color-action-border-strong)',
