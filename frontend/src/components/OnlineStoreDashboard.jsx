...
import MarketplaceProductTab from "./MarketplaceProductTab";
...
export default function OnlineStoreDashboard({
  ...
  const handleWithdrawal = async () => {
    ...
    try {
      await onlineStoreAPI.createWithdrawal(wdForm);
      flash("Withdrawal recorded");
      setShowWithdrawal(false);
    } catch (e) {
      flash(e.response?.data?.error || e.message);
    }
  };
  const totalGross = summary.platforms.reduce(
    (s, p) => s + parseFloat(p.gross_revenue || 0),
    0,
  );
  const totalNet = summary.platforms.reduce(
    (s, p) => s + parseFloat(p.net_revenue || 0),
    0,
  );
  const totalOrders = summary.platforms.reduce(
    (s, p) => s + parseInt(p.total_orders || 0),
    0,
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p style={{ margin: "4px 0 0", fontSize: "14px", color: sub }}>
            {totalOrders} total pesanan • {summary.platforms.length} platform
          </p>{" "}
        </div>{" "}
        ...
        <div>
          ...
          >
            ...
            >
              ...
              {loading ? (
                <Skeleton width="120px" height="28px" marginTop="6px" />
              ) : (
                <p
                  style={{
                    margin: "6px 0 0",
            ...
            >
              ...
              {loading ? (
                <Skeleton width="60px" height="28px" marginTop="6px" />
              ) : (
                <p
                  style={{
                    margin: "6px 0 0",
          ...
          >
            ...
            {summary.platforms.length ? (
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontSize: "16px",
                        fontWeight: "700",
                        color: platformColors[p.platform] || text,
              ...
              <p style={{ color: sub }}>
                Belum ada data. Import CSV untuk memulai.
              </p>
            )}{" "}
          </div>{" "}
        </div>
            ...
            <tbody>
              ...
              {!loading && !sales.length && (
                <tr>
                  ...
                  >
                    Belum ada transaksi. Import CSV untuk memulai.
                  </td>
                </tr>
              )}{" "}
            </tbody>{" "}
        ...
        >
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => setShowImport(false)}
                aria-label="Tutup modal import CSV"
                className="ui-motion-button ui-focus-ring"
                style={{
                  background: "none",
                  border: "none",
            ...
            >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setImportForm((f) => ({ ...f, platform: e.target.value }))
                  }
                  style={inputStyle}
                >
                  {" "}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setImportForm((f) => ({ ...f, csv_text: e.target.value }))
                  }
                  rows={8}
                  placeholder="Paste isi CSV dari export Shopee/TikTok..."
                  style={{
                    ...inputStyle,
                    fontFamily: "monospace",
                    fontSize: "12px",
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <label style={labelStyle}>Platform</label>{" "}
                <select
                  value={wdForm.platform}
                  onChange={(e) =>
                    setWdForm((f) => ({ ...f, platform: e.target.value }))
                  }
                  style={inputStyle}
                >
                  {" "}
      ...
      {/* Toast */}{" "}
      {/* v1.66.1: ganti toast buatan sendiri (kanan-bawah, zIndex 99999 yang seri dgn
          modal) dgn ToastNotice — posisi & ikon konsisten, render lewat portal. */}
      {toast && (
