    ...
    <div className="font-sans min-h-screen transition-all duration-300" style={{ padding: '2.5rem', marginLeft: isSidebarOpen ? '256px' : '80px', backgroundColor: bg }}>
      ...
      <div className="flex justify-between items-center mb-10">
        ...
        >
          ...
          <span className="text-sm font-semibold">Version 1.2.2</span>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-md transition-opacity">
          ...
          >
            ...
            <div className="relative p-8 text-center" style={{ background: 'linear-gradient(135deg, #007AFF 0%, #5856D6 100%)' }}>
              ...
              <p className="text-white/80 font-medium mt-1">Habil SuperApp v1.2.2 telah mengudara!</p>
            </div>
          ...
          >
            ...
            <div className="flex justify-between items-center p-6 border-b" style={{ borderColor: border }}>
              <div>
                ...
                <p className="text-xs mt-1" style={{ color: sub }}>Aktual: v1.2.2 - Terakhir diupdate 13 Mar 2026</p>
              </div>
