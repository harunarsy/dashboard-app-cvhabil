...
const changelog = [
  {
    version: 'v1.3.0-standard', date: '13 Mar 2026', status: 'latest',
    changes: [
      { type: 'fix', text: 'Universal Sync: Sinkronisasi total label versi ke format v1.3.0-standard.' },
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40 backdrop-blur-[2px] transition-opacity">
          ...
          >
            ...
            <div className="relative p-8 text-center" style={{ background: 'linear-gradient(135deg, #007AFF 0%, #5856D6 100%)' }}>
              ...
              <p className="text-white/80 font-medium mt-1">Habil SuperApp v1.3.0-standard telah mengudara!</p>
            </div>
          ...
          >
            ...
            <div className="flex justify-between items-center p-6 border-b" style={{ borderColor: border }}>
              <div>
                ...
                <p className="text-xs mt-1" style={{ color: sub }}>Aktual: v1.3.0-standard - Terakhir diupdate 13 Mar 2026</p>
              </div>
