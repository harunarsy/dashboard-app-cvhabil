...
function BugCard({ bug, isDark, onStatusChange }) {
  ...
  return (
    <div
      style={{
        backgroundColor: isDark ? "var(--color-surface-elevated)" : "#FFF",
        borderRadius: "12px",
        padding: "16px 18px",
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            ...
            <span style={{ fontSize: "12px", color: sub }}>
              {" "}
              {new Date(bug.reported_at).toLocaleString("id-ID", {
          ...
          <p
            style={{
              margin: "0 0 8px",
              fontSize: "13px",
              color: isDark ? "#EBEBF5" : "var(--color-border-strong)",
              lineHeight: "1.5",
            }}
          >
            {bug.description}
...
function StatusSection({
  ...
  return (
    <div
      style={{
        marginBottom: "16px",
        border: `1.5px solid ${count > 0 ? cfg.color + "40" : border}`,
        borderRadius: "14px",
        overflow: "hidden",
      }}
    >
      ...
      >
        ...
        <div
          style={{
            ...
            height: "32px",
            borderRadius: "8px",
            backgroundColor: isDark ? "var(--color-surface-raised)" : "#FFF",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
          }}
            ...
            backgroundColor:
              count > 0
                ...
                : isDark
                  ...
                  : "var(--color-border)",
            color: count > 0 ? "#FFF" : "var(--color-text-subtle)",
            padding: "2px 10px",
            borderRadius: "20px",
            minWidth: "28px",
            textAlign: "center",
      ...
      {open && (
        <div
          style={{
            padding: count > 0 ? "12px 14px 4px" : "0",
...
export default function BugReports({
  ...
  const filtered =
    filterType === "all" ? bugs : bugs.filter((b) => b.type === filterType);
  const grouped = {
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            Laporan dari pengguna — {bugs.length} total
          </p>{" "}
        </div>{" "}
      ...
      {loading ? (
        ...
        >
          ...
          >
            Semua sistem berjalan lancar. Tidak ada bug atau saran yang
            terdaftar.
          </p>{" "}
        </div>
      ) : (
