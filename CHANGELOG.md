...
### Changed
- **Global Version Synchronization**: Penyelarasan seluruh label versi dari v1.2.2/v1.2.4 menjadi v1.2.5 di seluruh komponen UI (Login, Dashboard, Footer) dan dokumentasi master.
