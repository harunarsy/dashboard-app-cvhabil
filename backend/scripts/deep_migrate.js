...
const SUPABASE_CONFIG = {
  connectionString: 'postgresql://postgres.bgaatkxqljvibjosliat:***REMOVED***@aws-1-ap-southeast-1.pooler.supabase.com:5432/postgres',
  ssl: { rejectUnauthorized: false }
};

const NEON_CONFIG = {
  connectionString: 'postgresql://neondb_owner:***REMOVED***@ep-frosty-glitter-a1kt0apa-pooler.ap-southeast-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require',
  ssl: { rejectUnauthorized: false }
};
